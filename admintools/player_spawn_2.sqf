...
private ["_admins","_mods","_members","_donors"];	

//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
#include "AdminTools-AccessList.sqf"
//!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

if (((getPlayerUID player) in _members || (getPlayerUID player) in _mods || (getPlayerUID player) in _admins || (getPlayerUID player) in _donors) || (player getVariable ["AllowTP",false])) then {	
	// override vars
	_maxDistanceTravel = 999999;
	_maxDistanceDebug = 999999;
	_maxDistanceZeroPos = 999999;
	_maxDistancePlayer = 999999;
	_maxDistanceVehicle = 999999;
} else {
// override vars
